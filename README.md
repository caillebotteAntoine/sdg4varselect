...
For comprehensive documentation and usage examples, please visit the [documentation site](https://sdg4varselect.readthedocs.io/en/latest/)
...
```
![Observed Serum Concentrations](examples/plot/readme_serum_concentration.png)
...
![Regularization Path](examples/plot/readme_regpath.png)
...
![Estimation of the low dimensional parameters](examples/plot/readme_estim_ld.png)
...
![Estimation of the high dimensional parameters](examples/plot/readme_estim_hd.png)
