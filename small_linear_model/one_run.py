...
from small_linear_model.model import jac_likelihood, likelihood, likelihood_array
from small_linear_model.sample import get_solver, sample
...
if __name__ == "__main__":
    ...
    # params0_start["mu1"] = params_star_weibull.mu1
    # params0_start["mu2"] = params_star_weibull.mu2
    # params0_start["gamma2_1"] = params_star_weibull.gamma2_1
    # params0_start["gamma2_2"] = params_star_weibull.gamma2_2
    params0_start["sigma2"] = params_star_weibull.sigma2
    params0_start["alpha"] = params_star_weibull.alpha
